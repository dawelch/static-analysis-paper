...
%\author[2]{Terry Jones}
%\author[4]{Thaleia Dimitra Doudali}
%\author[4]{Ada Gavrilovska}
%\author[3]{Barbara Chapman}
%\authorrunning{A. Welch et al.}
\affil[1]{University of Houston, Houston, TX}
\affil[2]{Oak Ridge National Laboratory, Oak Ridge, TN}
%\affil[3]{Stony Brook University, Stony Brook, NY}
%\affil[4]{Georgia Institute of Technology, Atlanta, GA}
