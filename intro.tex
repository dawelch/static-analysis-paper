...
Furthermore, considering the potentially costly process of porting applications \cite{openmpcug}, we need to explore partially or fully automated approaches to optimize existing codes written using de facto programming models.
