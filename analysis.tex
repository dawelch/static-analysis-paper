...
% \begin{table}[htbp]
% \caption{NAMD $PP_{MD}$ score components }
% \begin{center}
% \begin{tabular}{|c|c|}
% \hline
% \textbf{Non-portable component}&\textbf{Speedup provided ($\times$)} \\
% %\cline{2-3} 
% \hline
% CUDA-C$^{\mathrm{a}}$& 2.7\\
% \hline
% Charm++ LLCA& 1.9 \\
% \hline
% \multicolumn{2}{l}{\textbf{Final $PP_{MD}$}= 43\%} \\
% \hline
% \multicolumn{2}{l}{$^{\mathrm{a}}$ Averages from published NAMD benchmarks, \cite{namdperf,hardy2018improving}}
% \end{tabular}
% \label{namd_ppmd}
% \end{center}
% \end{table}
